...
import com.abdelrahman.raafat.climateClue.utils.*
...
class HomeFragment : Fragment() {
    ...
    private fun initUI() {
        ...
        binding.sunRiseTextView.isSelected = true
        binding.sunSetTextView.isSelected = true
        binding.windSpeed.isSelected = true
        binding.windDegree.isSelected = true
        binding.cloud.isSelected = true
        binding.pressure.isSelected = true
        binding.visibility.isSelected = true
        binding.ultraviolet.isSelected = true
    }
